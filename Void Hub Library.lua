...
function Utility:ElText(parent, title, desc, scope)
    ...
    }, { Utility:Padding({ left = 10, right = 8 }) })
       ...
       local function SelectTab()
        ...
        function Tab:Toggle(Config,type)
            ...
            local ToggleV = VoidUI:Create("Frame", {
                ...
                ZIndex = 15,
                -- sem ThemeID: toggle sempre dark
            },{
                VoidUI:Create("Frame", {
                    Name = "Knob",
                    AnchorPoint = Vector2.new(0.5, 0.5),
            ...
            function Togglee:SetValue(newValue)
                ...
                -- cores fixas estilo Dark (não mudam com theme)
                if newValue then
                    ...
                    Utility:TweenObject(ToggleV, {BackgroundColor3 = Color3.fromRGB(28, 28, 28)}, 0.2)
                    Utility:TweenObject(knob, {
                        Position = UDim2.new(0, 12, 0.5, 0),
                        BackgroundColor3 = Color3.fromRGB(160, 160, 160),
                        BackgroundTransparency = 0,
        ...
        function Tab:Dropdown(Config)
            ...
            local function openDropdown()
                ...
                -- Search com ícone (estilo Search da UI)
            ...
            local function closeDropdown()
                ...
                if FloatingMenu then
                    ...
                    SearchBox = nil
                    pcall(function()
                        Utility:TweenObject(fm, {Size = UDim2.new(0, fm.AbsoluteSize.X, 0, 0)}, 0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut)
                    end)
            ...
            -- Clique fora fecha (com delay para não fechar no mesmo click de abrir)
            ...
            -- também abre pelo clique na caixa de valor
            DropValueFrame.InputBegan:Connect(function(input)
                if Dropdown.Locked then return end
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
...
function UI:Notification(Config)
    coroutine.wrap(function()
        ...
        -- Barra de duração (dentro do card, não vaza)
