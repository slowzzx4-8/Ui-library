...
function UI:CreateWindow(Config)
    ...
    function Window:Tab(Config, type)
       ...
       local function SelectTab()
        ...
        -- Auto-select first tab so content is visible immediately
        ...
        function Tab:Dropdown(Config)
            -- Dropdown estilo source.lua + visual Void UI + Search
            local Dropdown = {
            ...
            local function rebuildOptions()
                ...
                local idx = 0
                for _, OptionName in ipairs(Dropdown.Option) do
                    if term == "" or string.find(string.lower(tostring(OptionName)), term, 1, true) then
                    idx = idx + 1
                    ...
                    OptionButton.MouseButton1Click:Connect(function()
                        ...
                        if Dropdown.Multi then
                            ...
                            if not found then table.insert(Dropdown.Options, OptionName) end
                            Dropdown.Value = Dropdown.Options
            ...
            local function openDropdown()
                ...
                local menuW = 180
                local menuH = math.clamp(#Dropdown.Option * 33 + 44, 100, 240)
                ...
                SearchBox = VoidUI:Create("TextBox", {
                    ...
                    TextXAlignment = Enum.TextXAlignment.Left,
                    FontFace = Font.new([[rbxassetid://12187365364]], Enum.FontWeight.Medium),
                    TextColor3 = (UI.Theme and UI.Theme.Text) or Color3.fromRGB(255, 255, 255),
                    ClearTextOnFocus = false,
                    ZIndex = 902,
                })
