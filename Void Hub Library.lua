...
function UI:CreateWindow(Config)
    ...
    function Window:Open()
        ...
        -- Restaura tamanhos corretos (sem animação pesada)
        ...
        -- Força atualização do canvas para não invadir o User
        if LeftScroll.UIListLayout then
            LeftScroll.CanvasSize = UDim2.new(0, 0, 0, LeftScroll.UIListLayout.AbsoluteContentSize.Y + 20)
        end
        ...
        -- Animação suave apenas do Island (botão minimizar)
        Utility:TweenObject(Island, {Position = UDim2.new(0.5, 0, -0.2, 0)}, 0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        task.defer(function()
            Utility:TweenObject(Island, {Size = UDim2.new(0, Island.UIListLayout.AbsoluteContentSize.X + 5, 0, 35)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        end)
    end

    function Window:Close()
        -- Fecha sem animação de encolher (instantâneo)
        ...
        Island.Visible = true
        MinzUI.Visible = true
        Utility:TweenObject(Island, {Position = UDim2.new(0.5, 0, -0.08, 0)}, 0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        task.defer(function()
            Utility:TweenObject(Island, {Size = UDim2.new(0, Island.UIListLayout.AbsoluteContentSize.X + 5, 0, 35)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
