...
function UI:CreateWindow(Config)
    ...
    function Window:SetTheme(themeName)
        ...
        UI.Theme = theme
        VoidUI:UpdateTheme(nil, true)
        -- fecha dropdown aberto para reabrir com cores novas
        ...
        function Tab:Dropdown(Config)
            ...
            local function rebuildItemsInto(parentScroll)
                ...
                for idx, Item in ipairs(items) do
                    ...
                    local function pick()
                        ...
                        selectingItem = true
                        -- animação de seleção
                        Utility:TweenObject(row, { BackgroundTransparency = 0, Size = UDim2.new(1, -4, 0, 32) }, 0.1)
                        task.delay(0.08, function()
                            pcall(function()
                                Utility:TweenObject(row, { Size = UDim2.new(1, -6, 0, 30) }, 0.1)
                            end)
                        end)
                        ...
                        task.delay(0.08, function() selectingItem = false end)
                    end
            ...
            local function openDropdown()
                ...
                task.defer(function()
                    ...
                    local menuW = math.clamp(math.max(absSize.X + 40, 180), 150, math.min(280, mainSize.X - 16))
                    ...
                    -- parent = Main → dropdown segue a UI e não sai dela
                    ...
                    Utility:TweenObject(FloatingMenu, { Size = UDim2.new(0, menuW, 0, menuH) }, 0.16, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
    ...
    function Window:Close()
        ...
        task.delay(0.22, function()
            ...
            OpenButtonHolder.Position = UDim2.new(0.5, 0, 0, 2)
