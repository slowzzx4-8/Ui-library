...
local CodeTab = Window:Tab({ Title = "Code View", Icon = "code", Border = true })
...
-- Code View (scroll X/Y + highlight)
CodeTab:Section({ Title = "View (read only)" })
CodeTab:Code({
    Title = "Example Script",
    Height = 150,
    Editable = false,
    Code = [[local VoidUI = loadstring(game:HttpGet("..."))()
local Window = VoidUI:CreateWindow({
    Name = "Void Ui",
    Theme = "Dark",
    Transparent = true,
...
CodeTab:Section({ Title = "Editor" })
local Editor = CodeTab:Code({
    Title = "Editable Code",
    Height = 140,
    Editable = true,
    MaxLines = 99999,
...
CodeTab:Code({
    ...
    Height = 100,
    Editable = false,
    Code = [[local highlight = Instance.new("Highlight")
