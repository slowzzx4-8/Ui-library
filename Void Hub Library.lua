...
VoidUI.Themes = {
    Dark = {
        ...
        ElementColor = Color3.fromHex("#2A2A2C"),
    ...
    Rose = {
        ...
        Outline = Color3.fromHex("#9f1239"),
        Placeholder = Color3.fromHex("#d67aa6"),
        IconColor = Color3.fromHex("#fb7185"),
        Primary = Color3.fromHex("#e95f74"),
    ...
    Red = {
        ...
        ElementColor = Color3.fromHex("#322221"),
    ...
    Indigo = {
        ...
        ElementColor = Color3.fromHex("#282543"),
        Outline = Color3.fromHex("#3730a3"),
        Placeholder = Color3.fromHex("#7078d9"),
        IconColor = Color3.fromHex("#6366f1"),
        Primary = Color3.fromHex("#4f46e5"),
        Button = Color3.fromHex("#4f46e5"),
    },
    Sky = {
        Name = "Sky",
        Background = Color3.fromHex("#051a26"),
        SideBar = Color3.fromHex("#0a4d66"),
        Text = Color3.fromHex("#e6f7ff"),
        ElementColor = Color3.fromHex("#172E3B"),
        Outline = Color3.fromHex("#00a8cc"),
        Placeholder = Color3.fromHex("#66b3cc"),
        IconColor = Color3.fromHex("#2db8d9"),
    ...
    Violet = {
        ...
        SideBar = Color3.fromHex("#3c1361"),
        Text = Color3.fromHex("#faf5ff"),
        ElementColor = Color3.fromHex("#342650"),
    ...
    Amber = {
        ...
        ElementColor = Color3.fromHex("#3A2E22"),
        Outline = Color3.fromHex("#b45309"),
        Placeholder = Color3.fromHex("#d1a326"),
        IconColor = Color3.fromHex("#f59e0b"),
        Primary = Color3.fromHex("#d97706"),
        Button = Color3.fromHex("#d97706"),
    },
    Emerald = {
        Name = "Emerald",
        Background = Color3.fromHex("#011411"),
        SideBar = Color3.fromHex("#022c22"),
        Text = Color3.fromHex("#ecfdf5"),
        ElementColor = Color3.fromHex("#202E2A"),
        Outline = Color3.fromHex("#047857"),
        Placeholder = Color3.fromHex("#3fbf8f"),
        IconColor = Color3.fromHex("#10b981"),
        Primary = Color3.fromHex("#059669"),
        Button = Color3.fromHex("#059669"),
    },
    Midnight = {
        Name = "Midnight",
        Background = Color3.fromHex("#0a0f1e"),
        SideBar = Color3.fromHex("#0c1e42"),
        Text = Color3.fromHex("#dbeafe"),
        ElementColor = Color3.fromHex("#242836"),
        Outline = Color3.fromHex("#1e3a8a"),
        Placeholder = Color3.fromHex("#2f74d1"),
        IconColor = Color3.fromHex("#5591f4"),
    ...
    Crimson = {
        ...
        SideBar = Color3.fromHex("#450a0a"),
        Text = Color3.fromHex("#fef2f2"),
        ElementColor = Color3.fromHex("#251F1F"),
        Outline = Color3.fromHex("#b91c1c"),
        Placeholder = Color3.fromHex("#6f757b"),
        IconColor = Color3.fromHex("#dc2626"),
        Primary = Color3.fromHex("#991b1b"),
        Button = Color3.fromHex("#991b1b"),
    },
    MonokaiPro = {
        Name = "MonokaiPro",
        Background = Color3.fromHex("#191622"),
        SideBar = Color3.fromHex("#1e1e1e"),
        Text = Color3.fromHex("#fcfcfa"),
        ElementColor = Color3.fromHex("#323039"),
        Outline = Color3.fromHex("#ab9df2"),
        Placeholder = Color3.fromHex("#afafaf"),
        IconColor = Color3.fromHex("#a9dc76"),
        Primary = Color3.fromHex("#fc9867"),
...
function UI:CreateWindow(Config)
    ...
    --UIMinimized
    local Main
    local MinzUI = VoidUI:Create("Frame", {
        Parent = Island,
        LayoutOrder = 1,
    ...
    local DragDivider = VoidUI:Create("Frame", {
        Parent = MinzUI,
    ...
    -- Clickable area with icon + title
    local OpenBtnInner = VoidUI:Create("TextButton", {
        Parent = MinzUI,
        AutomaticSize = Enum.AutomaticSize.X,
    ...
    local UIIcon = VoidUI:Create("ImageLabel", {
        ...
        Size = UDim2.new(0, 20, 0, 20),
        BackgroundTransparency = 1,
        Image = Window.Icon and GetIcon(Window.Icon) or "",
        Visible = Window.Icon ~= nil,
        LayoutOrder = 0,
        ZIndex = 152,
        ImageColor3 = Color3.fromRGB(255, 255, 255),
    })

    local OpenTitle = VoidUI:Create("TextLabel", {
        Parent = OpenBtnInner,
        BackgroundTransparency = 1,
        AutomaticSize = Enum.AutomaticSize.X,
    ...
    -- Hover effect
    OpenBtnInner.MouseEnter:Connect(function()
        Utility:TweenObject(OpenBtnInner, {BackgroundTransparency = 0.93, BackgroundColor3 = Color3.fromRGB(255,255,255)}, 0.1)
    end)
    OpenBtnInner.MouseLeave:Connect(function()
        Utility:TweenObject(OpenBtnInner, {BackgroundTransparency = 1}, 0.1)
    end)

    -- Auto size Island when MinzUI content changes
    MinzUI:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
        -- keep island sizing via existing layout
    end)
    ...
    function Window:EditOpenButton(Config)
        local Edit = {
            ...
            Color = Config.Color or ColorSequence.new(Color3.fromHex("40c9ff"), Color3.fromHex("e81cff")),
            ...
            StrokeThickness = Config.StrokeThickness or 1.5,
            CornerRadius = Config.CornerRadius or UDim.new(1, 0),
            Draggable = Config.Draggable ~= false,
            OnlyIcon = Config.OnlyIcon or false,
        }
        OpenTitle.Text = Edit.Title
        MinzUI.UICorner.CornerRadius = Edit.CornerRadius
        MinzUI.BackgroundTransparency = Edit.Transparency

        if Edit.Icon then
            UIIcon.Visible = true
            local ok, img = pcall(GetIcon, Edit.Icon)
            if ok and img then
                UIIcon.Image = typeof(img) == "table" and (img.Image or "") or img
            elseif typeof(Edit.Icon) == "string" and string.find(Edit.Icon, "rbxassetid://") then
        ...
        if Edit.OnlyIcon then
            OpenTitle.Visible = false
        end

        if Edit.Draggable == false then
            DragHandle.Visible = false
            DragDivider.Visible = false
        end
    ...
    SearchBox.FocusLost:Connect(function()
        task.wait(0.1)
        -- Aqui voltamos o Y Size para 0 e a Posição para o estado original (0, 0, 0, 25)
    ...
    function Window:Tab(Config, type)
       ...
       local function SelectTab()
        ...
        function Tab:Colorpicker(Config)
            ...
            local hasAlpha = Colorpicker.Transparency ~= nil
            ...
            local function OpenColorDialog()
                ...
                -- Animate open
                Utility:TweenObject(Dialog, {Size = UDim2.new(0, 340, 0, hasAlpha and 370 or 340)}, 0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)

                local DialogTitle = VoidUI:Create("TextLabel", {
                    Parent = Dialog,
                ...
                local hueKeys = {}
                for i = 0, 1, 0.1 do
                    table.insert(hueKeys, ColorSequenceKeypoint.new(i, Color3.fromHSV(i, 1, 1)))
                end

                local HueBar = VoidUI:Create("Frame", {
                    Parent = Dialog,
                    Size = UDim2.new(0, 14, 0, 170),
                    Position = UDim2.new(0, 204, 0, 48),
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                    ZIndex = 302,
                }, {
                    VoidUI:Create("UICorner", { CornerRadius = UDim.new(1, 0) }),
                ...
                -- Preview boxes (solid + checkerboard style)
                local PreviewSolid = VoidUI:Create("Frame", {
                    Parent = Dialog,
                ...
                local PreviewChecker = VoidUI:Create("ImageLabel", {
                    Parent = Dialog,
                    Size = UDim2.new(0, 50, 0, 24),
                    Position = UDim2.new(0, 70, 0, 230),
                ...
                -- Inputs container
                local InputsFrame = VoidUI:Create("Frame", {
                    Parent = Dialog,
                    Size = UDim2.new(0, 110, 0, 170),
                    Position = UDim2.new(0, 230, 0, 48),
                    BackgroundTransparency = 1,
                    ZIndex = 302,
                }, {
                    VoidUI:Create("UIListLayout", {
                ...
                local function MakeInput(label, value)
                    ...
                    local tb = VoidUI:Create("TextBox", {
                        Parent = box,
                        ...
                        VoidUI:Create("UIPadding", { PaddingLeft = UDim.new(0, 10) }),
                    })
                    return tb
                end

                local HexBox = MakeInput("Hex", "#" .. currentColor:ToHex())
                local rgb = ToRGB(currentColor)
                local RBox = MakeInput("R", rgb.R)
                local GBox = MakeInput("G", rgb.G)
                local BBox = MakeInput("B", rgb.B)
                local ABox
                if hasAlpha then
                    ABox = MakeInput("A", math.floor((1 - currentTransparency) * 100) .. "%")
                end
                ...
                local function UpdateDisplay()
                    ...
                    PreviewSolid.BackgroundColor3 = col
                    local checkerInner = PreviewChecker:FindFirstChildOfClass("Frame")
                    if checkerInner then
                        checkerInner.BackgroundColor3 = col
                        checkerInner.BackgroundTransparency = currentTransparency
                    end
                    HexBox.Text = "#" .. col:ToHex()
                    local r = ToRGB(col)
                    RBox.Text = tostring(r.R)
                    GBox.Text = tostring(r.G)
                    BBox.Text = tostring(r.B)
                    if ABox then
                        ABox.Text = math.floor((1 - currentTransparency) * 100) .. "%"
                    end
                end
                ...
                table.insert(connections, SatVibMap.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                        dragging = "sat"
                    end
                end))
                ...
                table.insert(connections, UserInputService.InputChanged:Connect(function(input)
                    ...
                    if dragging == "sat" then
                        local abs, size = SatVibMap.AbsolutePosition, SatVibMap.AbsoluteSize
                    ...
                    elseif dragging == "hue" then
                        local abs, size = HueBar.AbsolutePosition, HueBar.AbsoluteSize
                        local my = math.clamp(input.Position.Y, abs.Y, abs.Y + size.Y)
                        h = (my - abs.Y) / size.Y
                        UpdateDisplay()
                    end
                ...
                table.insert(connections, HexBox.FocusLost:Connect(function(enter)
                ...
                local function bindRGB(box, channel)
                    table.insert(connections, box.FocusLost:Connect(function(enter)
                        ...
                        local r = ToRGB(Color3.fromHSV(h, s, v))
                        r[channel] = val
                        local col = Color3.fromRGB(r.R, r.G, r.B)
                        h, s, v = Color3.toHSV(col)
                        UpdateDisplay()
                    end))
                end
                ...
                if ABox then
                    table.insert(connections, ABox.FocusLost:Connect(function(enter)
                        if not enter then return end
                        local val = math.clamp(tonumber((ABox.Text:gsub("%%", ""))) or 100, 0, 100)
                        currentTransparency = 1 - (val * 0.01)
                        UpdateDisplay()
                    end))
                end
                ...
                local function CloseDialog()
                    ...
                    dialogOpen = false
                    Utility:TweenObject(Dialog, {Size = UDim2.new(0, 0, 0, 0)}, 0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
                    task.wait(0.15)
                    Overlay:Destroy()
                end
                ...
                ApplyBtn.MouseButton1Click:Connect(function()
                    ...
                    Colorpicker.Transparency = currentTransparency
                    task.spawn(function()
    ...
    function Window:Open()
        ...
        -- Restaura tudo instantaneamente (sem animação de abrir a UI)
        Main.Visible = true
        ...
        -- Corrige o espaço do User/Anonymous para não ser invadido (após minimizar)
        local scrollOffset = (Window.User.Enabled and -50) or -10
        LeftScroll.Size = UDim2.new(1, 0, 1, scrollOffset)

        -- Garante que UserFrame continue visível e posicionado corretamente (ele é filho do TabFrame, some junto ao minimizar)
        ...
        -- Força atualização do layout após restaurar o tamanho (evita bug de invasão)
        task.defer(function()
            if LeftScroll.UIListLayout then
                LeftScroll.CanvasSize = UDim2.new(0, 0, 0, LeftScroll.UIListLayout.AbsoluteContentSize.Y + 20)
            end
        ...
        -- Animação suave só do botão Island (minimizado → escondido)
        MinzUI.Visible = false
        Island.Visible = true
        Utility:TweenObject(Island, {Position = UDim2.new(0.5, 0, -0.2, 0)}, 0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        task.defer(function()
            local targetW = Island.UIListLayout.AbsoluteContentSize.X + 5
            Utility:TweenObject(Island, {Size = UDim2.new(0, targetW, 0, 35)}, 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        end)
    ...
    function Window:Close()
        ...
        -- Fecha a UI SEM animação (instantâneo)
        ...
        -- UserFrame some junto porque é filho do TabFrame/Main (já fica escondido com Main.Visible = false)

        -- Apenas o Island/MinzUI tem animação suave
        Island.Visible = true
        MinzUI.Visible = true
        Utility:TweenObject(Island, {Position = UDim2.new(0.5, 0, -0.08, 0)}, 0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        task.defer(function()
            local islandW = Island.UIListLayout.AbsoluteContentSize.X + 5
            Utility:TweenObject(Island, {Size = UDim2.new(0, islandW, 0, 48)}, 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            -- MinzUI uses AutomaticSize.X, keep height 44
            MinzUI.Size = UDim2.new(0, 0, 0, 44)
        end)
    ...
    OpenBtnInner.MouseButton1Click:Connect(function()
    ...
    function Window:Resize(sizeX, sizeY, isDrag)
        ...
        if isDrag then
            -- Modo ultraleve para o arrasto do mouse (sem delay/tweens travados)
            ...
            -- Modo animado apenas para botões externos (como o Apply)
            ...
            Utility:TweenObject(TopBarF1, {Size = UDim2.new(0, sizeX - 20 - TopBarF2.Size.X.Offset - 187, 0, Window.Topbar.Height)}, 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    ...
    local ResizeHandle = VoidUI:Create("Frame", {
        Parent = Main,
        Size = UDim2.new(0, 20, 0, 20),
        Position = UDim2.new(1, 6, 1, 6), -- Offset positivo empurra o botão 6 pixels para fora da UI
        AnchorPoint = Vector2.new(1, 1),
        BackgroundTransparency = 1,
        ZIndex = 499,
        Active = true,
    ...
    UserInputService.InputChanged:Connect(function(input)
        if resizing and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
            ...
            -- Enviamos "true" como terceiro argumento para aplicar o tamanho sem lag
...
function UI:Notification(Config)
    coroutine.wrap(function()
        ...
        local NotifFrame = VoidUI:Create("Frame", {
            Parent = Island,
            BackgroundColor3 = Color3.fromRGB(20, 20, 20),
            BackgroundTransparency = 0.2,
            BorderSizePixel = 0,
            ...
            VoidUI:Create("UICorner", { CornerRadius = UDim.new(0, 12) }),
            VoidUI:Create("UIPadding", { PaddingTop = UDim.new(0, 9) }),
            VoidUI:Create("UIStroke", {
                LineJoinMode = "Round",
                Thickness = 0.6,
                ThemeID = {
        ...
        if Notification.Desc then
            ...
            Desc = Text(NotifFrame, Notification.Desc, {
                ...
                VoidUI:Create("UIPadding", { PaddingLeft = UDim.new(0, 10),PaddingTop = UDim.new(0, 10)})
            })
    ...
    local NotifDelay = VoidUI:Create("Frame", {
        Parent = NotifFrame,
        ClipsDescendants = true,
        AnchorPoint = Vector2.new(0,1),
    ...
    --[[local NotifFrame1 = VoidUI:Create("Frame", {
        Parent = NotifFrame,
        BackgroundTransparency = 0.1,
        BorderSizePixel = 0,
        LayoutOrder = 2,
    ...
    NotifFrame.MouseLeave:connect(function()
        ...
        -- Cálculo da largura baseado no texto para fazer Auto-Size
        task.delay(0.05, function()
            local titleWidth = Title.Frame.AbsoluteSize.X
            local descWidth = Desc and Desc.Frame.AbsoluteSize.X or 0
            local targetWidth = math.max(titleWidth, descWidth) + (Notification.Icon and 45 or 25)
            
            Utility:TweenObject(NotifFrame, {Size = UDim2.new(0, targetWidth, 0, 30)}, 0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            coroutine.wrap(function()
                Utility:TweenObject(NotifDelay, {Size = UDim2.new(0, targetWidth - 32, 0, 1)}, 0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
                task.wait(0.5)
...
Settings:Dropdown({
	Title = "Theme",
	Option = {"Dark","Light","Rose","Plant","Red","Indigo","Sky","Violet","Amber","Emerald","Midnight","Crimson","MonokaiPro","CottonCandy","Mellowsi"},
	Value = "Dark",
	Callback = function(Value)
