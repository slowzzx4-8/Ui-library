...
-- Watermark: só ping + bolinha (verde / laranja / vermelho)
...
local function updateWatermark()
    ...
    pcall(function()
        Window:SetWatermark(string.format("%s  %d ms", pingColorDot(ping), ping))
    end)
end
updateWatermark()
...
local function saveUserConfig()
    pcall(function()
        ...
        Window:SetConfig("saveConfigOnExit", State.saveConfigOnExit == true)
        Window:SetConfig("anonymous", true)
...
local function loadUserConfig()
    pcall(function()
        ...
        local saveExit = Window:GetConfig("saveConfigOnExit", true)
        ...
        State.saveConfigOnExit = saveExit ~= false
    end)
end
loadUserConfig()
...
pcall(function()
    Window:OnDestroy(function()
        if State.saveConfigOnExit then
            saveUserConfig()
        end
        pcall(shutdown)
    end)
