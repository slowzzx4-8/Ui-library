...
VoidUI.Themes = {
    ...
    Crimson = {
        ...
        ElementColor = Color3.fromRGB(45, 25, 25),
        Outline = Color3.fromRGB(80, 40, 40),
        Placeholder = Color3.fromRGB(20, 12, 12),
...
function UI:CreateWindow(Config)
    ...
    --UIMinimized
    local Main
    local MinzUI = VoidUI:Create("TextButton", {
        Parent = Island,
        LayoutOrder = 1,
        ...
        VoidUI:Create("UIStroke", {Parent = ButtonModule,
    ...
    local UIIcon
    if Window.Icon then
        UIIcon = VoidUI:Create("ImageLabel", {
            AnchorPoint = Vector2.new(0, 0.5),
    ...
    if Window.KeySystem and Window.KeySystem.KeyValidator then
        ...
        local Providers = KeyConfig.Providers or {
            { Name = "LootLabs", URL = KeyConfig.URL or "", Image = "rbxassetid://136873032740635" },
            { Name = "Linkvertise", URL = KeyConfig.URL or "", Image = "rbxassetid://123672470195625" },
            { Name = "Work.ink", URL = KeyConfig.URL or "", Image = "rbxassetid://91939244392940" },
        }

        local KeyFrame = VoidUI:Create("Frame", {
            Parent = UIScreen,
            Size = UDim2.new(0, 340, 0, 385),
            ClipsDescendants = true,
            Active = true,
            AnchorPoint = Vector2.new(0.5, 0.5),
            Position = UDim2.new(0.5, 0, 0.5, 0),
        ...
        -- Input Row (Paste + TextBox)
        local InputRow = VoidUI:Create("Frame", {
            Parent = KeyFrame,
            Size = UDim2.new(1, -28, 0, 38),
            Position = UDim2.new(0, 14, 0, 115),
            BackgroundTransparency = 1,
            ZIndex = 201,
        })

        local PasteBtn = VoidUI:Create("TextButton", {
            Parent = InputRow,
        ...
        local PasteIcon = VoidUI:Create("ImageLabel", {
            Parent = PasteBtn,
        ...
        KeyBoxStroke = VoidUI:Create("UIStroke", {
            Parent = KeyBox,
        ...
        local ErrorLabel = VoidUI:Create("TextLabel", {
            Parent = KeyFrame,
        ...
        PasteBtn.MouseButton1Click:Connect(function()
            ...
            if ok and result and tostring(result) ~= "" then
                clip = tostring(result)
            end
            if clip and #clip > 0 then
                KeyBox.Text = clip:gsub("%s+", "")
                ErrorLabel.Visible = false
                KeyBoxStroke.Color = Color3.fromRGB(55, 55, 55)
            end
        end)
        ...
        local SubmitBtn = VoidUI:Create("TextButton", {
            ...
            VoidUI:Create("UICorner", { CornerRadius = UDim.new(0, 11) }),
            VoidUI:Create("UIStroke", {
                Color = Color3.fromRGB(60, 60, 60),
                Thickness = 1,
            }),
        ...
        local DiscordIcon = VoidUI:Create("ImageLabel", {
            Parent = DiscordRow,
            Size = UDim2.new(0, 16, 0, 16),
            Position = UDim2.new(0.5, -95, 0.5, -8),
            BackgroundTransparency = 1,
            Image = "rbxassetid://75748074936470",
            ImageColor3 = Color3.fromRGB(88, 101, 242), -- cor oficial do Discord
            ZIndex = 203,
        })

        local DiscordBtn = VoidUI:Create("TextButton", {
            Parent = DiscordRow,
            Size = UDim2.new(1, 0, 1, 0),
            BackgroundTransparency = 1,
        ...
        DiscordBtn.MouseButton1Click:Connect(function()
            ...
            DiscordBtn.TextColor3 = Color3.fromRGB(100, 200, 120)
            task.wait(1.2)
            DiscordBtn.Text = "    Need support? Join the Discord"
        ...
        -- Provider Buttons
        local ProviderRow = VoidUI:Create("Frame", {
            Parent = KeyFrame,
            Size = UDim2.new(1, -28, 0, 36),
            Position = UDim2.new(0, 14, 0, 275),
            BackgroundTransparency = 1,
            ZIndex = 201,
        }, {
            VoidUI:Create("UIListLayout", {
        ...
        for _, prov in ipairs(Providers) do
            local pBtn = VoidUI:Create("TextButton", {
                Parent = ProviderRow,
            ...
            local pLabel = VoidUI:Create("TextLabel", {
                Parent = pBtn,
            ...
            pBtn.MouseButton1Click:Connect(function()
                if prov.URL and #prov.URL > 0 then
                    setclipboard(prov.URL)
                    pLabel.Text = "Copied!"
                    task.wait(1)
                    pLabel.Text = prov.Name
                end
            end)
        end
        ...
        SubmitBtn.MouseButton1Click:Connect(function()
            ...
            if valid then
                ...
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(30, 160, 60) -- verde vivo
                KeyBoxStroke.Color = Color3.fromRGB(30, 160, 60)
                task.wait(0.55)
                KeyFrame:Destroy()
                ...
                SubmitBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(200, 40, 40) -- vermelho vivo
                ErrorLabel.Text = "Incorrect key. Please try again."
                ErrorLabel.Visible = true
                KeyBoxStroke.Color = Color3.fromRGB(200, 40, 40)
                task.wait(1.4)
                SubmitBtn.Text = "Submit Key  >"
                SubmitBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- preto normal
            end
        end)
    ...
    function Window:Close()
        ...
        task.defer(function()
            ...
            local minzW = MinzUI.UIListLayout.AbsoluteContentSize.X + 10
            Utility:TweenObject(Island, {Size = UDim2.new(0, islandW, 0, 35)}, 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            Utility:TweenObject(MinzUI, {Size = UDim2.new(0, minzW, 0, 30)}, 0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        end)
