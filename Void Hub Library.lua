...
function UI:CreateWindow(Config)
    ...
    if Window.KeySystem and Window.KeySystem.KeyValidator then
        ...
        -- Status badge (filled circle with icon) - matches the screenshots better
        ...
        for _, prov in ipairs(Providers) do
            ...
            if prov.Image then
                VoidUI:Create("ImageLabel", {
                    Parent = pBtn,
                    Size = UDim2.new(0, 15, 0, 15),
                    Position = UDim2.new(0, 9, 0.5, -7.5),
                    BackgroundTransparency = 1,
                    Image = prov.Image,
                    ZIndex = 203,
                })
        ...
        SubmitBtn.MouseButton1Click:Connect(function()
            ...
            if valid then
                ...
                -- Success state (image 1)
                SubmitBtn.Text = "Submit Key  >"
                SubmitBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
                SubmitBtn.BackgroundColor3 = Color3.fromRGB(42, 135, 62) -- verde vivo mas controlado
                SetStatus("success")
