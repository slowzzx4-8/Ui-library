...
function UI:CreateWindow(Config)
    ...
    function Window:SetTheme(themeName)
        ...
        -- base da UI = Dark/Light completo; outros temas só IconColor
        local base = VoidUI.Themes.Dark
        if themeName == "Light" then
            base = VoidUI.Themes.Light
            UI.Theme = {
                Name = "Light",
                Background = base.Background, SideBar = base.SideBar, Text = base.Text,
                ElementColor = base.ElementColor, Outline = base.Outline, Placeholder = base.Placeholder,
                IconColor = theme.IconColor or base.IconColor,
            }
            VoidUI:UpdateTheme(nil, true)
        elseif themeName == "Dark" then
            ...
            -- mantém aparência Dark, só muda ícones
            local cur = UI.Theme or base
            UI.Theme = {
                Name = theme.Name or themeName,
                Background = cur.Background or base.Background,
                SideBar = cur.SideBar or base.SideBar,
                Text = cur.Text or base.Text,
                ElementColor = cur.ElementColor or base.ElementColor,
                Outline = cur.Outline or base.Outline,
                Placeholder = cur.Placeholder or base.Placeholder,
                IconColor = theme.IconColor or base.IconColor,
            }
        ...
        function Tab:Dropdown(Config)
            ...
            local function rebuildItemsInto(parentScroll)
                ...
                for idx, Item in ipairs(items) do
                    ...
                    -- estilo WindUI: linhas com leve fundo arredondado
                    ...
                    local label = VoidUI:Create("TextLabel", {
                        ...
                        BackgroundTransparency = 1,
                        Text = tostring(Item),
                        TextTransparency = selected and 0 or 0.2,
                        TextSize = 13,
                        FontFace = Font.new([[rbxassetid://12187365364]], Enum.FontWeight.Medium),
                        TextColor3 = txtCol,
                        TextXAlignment = Enum.TextXAlignment.Left,
            ...
            local function placeMenuInsideMain(menu, menuW, menuH)
                ...
                -- sempre abaixo do campo; alinhado à direita do trigger (estilo Wind)
    ...
    function Window:Open()
        ...
        task.defer(function()
            ...
            -- sempre garante primeira aba aberta ao abrir a UI
