...
-- Icons: nunca quebrar a library se o HttpGet falhar
local IconsV2 = nil
do
    ...
    if ok and type(result) == "table" then
        ...
        warn("[Void Ui] Icons pack failed to load — using empty fallback")
        IconsV2 = {
    ...
    function Window:Tab(Config, type)
       ...
       local function SelectTab()
        ...
        function Tab:Dropdown(Config)
            ...
            -- forward declare (Lua local scope) — evita closeDropdown nil na seleção
            local closeDropdown
            local openDropdown
