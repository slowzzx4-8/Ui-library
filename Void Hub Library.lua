       ...
       local function SelectTab()
        ...
        function Tab:Dropdown(Config)
            ...
            local function rebuildItemsInto(parentScroll)
                ...
                for idx, Item in ipairs(items) do
                    ...
                    local row = VoidUI:Create("TextButton", {
                        ...
                        BackgroundTransparency = selected and 0.05 or 0.4,
                    ...
                    local label = VoidUI:Create("TextLabel", {
                        ...
                        BackgroundTransparency = 1,
                        Text = tostring(Item),
                        TextTransparency = selected and 0 or 0.3,
                        TextSize = 13,
                        FontFace = Font.new([[rbxassetid://12187365364]], Enum.FontWeight.SemiBold),
                        TextColor3 = txtCol,
                        TextXAlignment = Enum.TextXAlignment.Left,
                            ...
                            for _, r in ipairs(parentScroll:GetChildren()) do
                                if r:IsA("TextButton") then
                                    ...
                                    if lab then
                                        ...
                                        r.BackgroundTransparency = isSel and 0.05 or 0.4
                                        r.BackgroundColor3 = elC
                                        lab.TextTransparency = isSel and 0 or 0.3
                                    end
                                end
                            end
            ...
            local function openDropdown()
                ...
                -- fecha qualquer outro dropdown aberto (estilo WindUI)
                UI:CloseActiveDropdown()
                DropOpen = true
                openTick = tick()
        ...
        function Tab:Code(Config)
            local CD = {
                ...
                MaxLines = math.clamp(Config.MaxLines or 99999, 1, 99999),
            }
