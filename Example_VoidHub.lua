...
local DemoTab = Window:Tab({ Title = "Demo", Icon = "layout-list", Border = true })
...
-- Demo / TabSection + Dropdown estilo lista
DemoTab:TabSection({ Title = "Animals" })
DemoTab:Dropdown({
    Title = "Select Pet",
    Desc = "Lista limpa com Search",
    Option = {
        "Kiwi", "Blood Kiwi", "Owl", "Panda", "Spotted Deer",
        "Golden Lab", "Frog", "Red Dragon", "Cow", "Cat",
        "Dog", "Fox", "Bear", "Rabbit", "Eagle",
    },
    Value = "Kiwi",
    Callback = function(v) print("Pet:", v) end,
})
DemoTab:TabSection({ Title = "Controls" })
DemoTab:Toggle({ Title = "Auto Farm", Default = false, Callback = function(v) print("AutoFarm", v) end })
DemoTab:Toggle({ Title = "Show ESP", Default = true, Callback = function(v) print("ShowESP", v) end })
DemoTab:Button({ Title = "Refresh List", Callback = function() Window:Notify({ Title = "Demo", Content = "Refreshed", Duration = 2 }) end })
DemoTab:Button({ Title = "Reset", Callback = function() Window:Notify({ Title = "Demo", Content = "Reset done", Duration = 2 }) end })
DemoTab:TabSection({ Title = "Multi Select" })
DemoTab:Dropdown({
    Title = "Fruits",
    Multi = true,
    Option = { "Apple", "Banana", "Orange", "Mango", "Grape", "Kiwi" },
    Value = { "Apple" },
    Callback = function(v) print("Fruits", v) end,
})
...
AppearanceTab:Dropdown({
    Title = "Font Family",
    Option = {
        "Builder Sans (Default)", "Gotham", "Source Sans Pro",
        "Roboto", "Roboto Mono", "Montserrat", "Nunito",
        "Oswald", "Ubuntu", "Arial", "Inconsolata", "Comic Neue",
        "Legacy", "Highway", "SciFi", "Arcade", "Bodoni",
        "Garamond", "GothamBold", "Code", "Fondamento", "FredokaOne",
    },
...
LockedTab:Button({ Title = "Lock Tab", Callback = function() LockedTab:LockAll() end })
LockedTab:Button({ Title = "Unlock Tab", Callback = function() LockedTab:UnlockAll() end })
LockedTab:Button({ Title = "Lock Window", Callback = function() Window:LockAll() end })
LockedTab:Button({ Title = "Unlock Window", Callback = function() Window:UnlockAll() end })

-- Settings
Settings:Section({ Title = "Theme" })
local AllThemes = {
    "Dark","Light",
    "Pink","Blue","Purple","Yellow","Green","Brown","Red",
