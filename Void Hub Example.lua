...
if isfile and isfile("Void Hub Library.lua") then
    VoidUI = loadstring(readfile("Void Hub Library.lua"))()
else
    VoidUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/slowzzx4-8/Ui-library/refs/heads/main/Void%20Hub%20Library.lua"))()
end
...
T.Theme:Button({
    ...
    Callback = function()
        ...
        VoidUI:Notification({ Title = "Theme", Desc = "Applied: " .. SelectedTheme, Duration = 2 })
    end,
})
...
T.Theme:Button({
    ...
    Callback = function()
        ...
        if id == "" then VoidUI:Notification({ Title = "BG", Desc = "Empty id", Duration = 2 }) return end
        pcall(function() Window:SetBackgroundImage(id, 0.25) end)
        VoidUI:Notification({ Title = "BG", Desc = "Image applied", Duration = 2 })
    end,
})
...
T.Theme:Button({
    ...
    Callback = function()
        ...
        VoidUI:Notification({ Title = "BG", Desc = "Video applied", Duration = 2 })
    end,
})
...
for i = 1, 20 do
    ...
    T.Main:Button({ Title = "Action " .. n, Callback = function()
        VoidUI:Notification({ Title = "Action", Desc = "Pressed " .. n, Duration = 1.2 })
    end })
end
...
for i = 1, 12 do
    ...
    T.Teleport:Button({ Title = "TP Loc " .. n, Callback = function()
        VoidUI:Notification({ Title = "TP", Desc = "Location " .. n, Duration = 1.2 })
    end })
end
...
pcall(function() T.Advanced:Accordion({ Title = "Info", Desc = "Details here", Open = false }) end)
