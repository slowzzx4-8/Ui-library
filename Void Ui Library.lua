    ...
    function Window:Tab(Config, type)
       ...
       local function SelectTab()
        ...
        function Tab:Dropdown(Config)
            ...
            local function placeMenuOutsideLeft(menu, menuW, menuH)
                ...
                -- fora da UI, lado esquerdo, encostado na borda
                local gap = 2
                local x = mainPos.X - w - gap
                local y = mainPos.Y
                -- se sair da tela à esquerda, cola na borda esquerda da tela
                if x < 4 then x = 4 end
            ...
            local function openDropdown()
                ...
                task.defer(function()
                    ...
                    placeMenuOutsideLeft(FloatingMenu, menuW, menuH)
