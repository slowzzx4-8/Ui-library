...
function UI:CreateWindow(Config)
    ...
    function Window:Tab(Config, type)
       ...
       local function SelectTab()
            ...
            local contentH = math.max(80, Window.Size.Y.Offset - Window.Topbar.Height - 20 - (Tags > 0 and 37 or 0))
            ElementFrame.Size = UDim2.new(0, contentW, 0, contentH)
            ElementFrame.BackgroundTransparency = 0.2
            -- atualiza largura dos itens já criados
            for _, item in ipairs(RightScroll:GetChildren()) do
                if item:IsA("Frame") then
                    item.Size = UDim2.new(0, contentW - 10, 0, item.Size.Y.Offset)
                end
            end
        ...
        function Tab:Dropdown(Config)
            ...
            local DropDownElement = VoidUI:Create("Frame", {
                ...
                BackgroundTransparency = 1,
                AutomaticSize = "Y",
                Size = UDim2.new(0, ElementFrame.Size.X.Offset - 10, 0, 46),
                ZIndex = 15,
            })
