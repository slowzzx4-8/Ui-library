...
pcall(function() Window:SetWatermark("Muscle Legends  •  By Slowzzx4") end)
...
local function activeStatusText()
    ...
    if State.fly then parts[#parts + 1] = "Fly" end
...
Tabs.Misc:TabSection({ Title = "Movement" })
Tabs.Misc:Toggle({
    Title = "Fly",
    Default = false,
...
Tabs.Misc:Slider({
    ...
    Step = 1,
    Callback = function(v) State.flyLevel = v end,
})
Tabs.Misc:Toggle({
    Title = "Spin",
    Default = false,
